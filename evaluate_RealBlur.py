...
def compute_ssim(tar_img, prd_img, cr1):
    ssim_pre, ssim_map = structural_similarity(tar_img, prd_img,
                                                 multichannel=True, 
                                                 gaussian_weights=True, 
                                                 use_sample_covariance=False, 
                                                 data_range = 1.0, 
                                                 full=True, channel_axis=-1)
...
if __name__ == '__main__':
    ...
    for dataset in datasets:
        ...
        # file_path = os.path.join('../results/UFPNet-RealBlurR-train-on-RealBlurR/visualization', dataset)
        file_path = '/mnt/sub_hdd/debluring/TSMPNet/results/RealBlur_R_REALLAST/visualization/merge'
        # gt_path = os.path.join('D:/Fang/dataset/Deblur', dataset, 'test/target')
        # gt_path = '/home/work/image_restoration/TSMPNet/datasets/test/RealBlur_J/target'
        gt_path = '/mnt/sub_hdd/debluring/TSMPNet/datasets/RealBlur/RealBlur-R/test/sharp'
